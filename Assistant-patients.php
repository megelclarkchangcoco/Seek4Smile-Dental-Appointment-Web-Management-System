...
$assistantID = $_SESSION['AssistantID'];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['subject'])) {
    ...
    $insertQuery = "INSERT INTO medicalrecord (PatientID, AssistantID, subject, filename) 
                    VALUES ('$patientID', '$assistantID', '$subject', '$filename')";
...
// If a patient is selected, get additional info
if ($selectedPatient) {
    ...
    // --- Update missing PrescriptionID values ---
    ...
    // Normalized Prescription Query (Medications)
    $prescriptionQuery = "
        SELECT 
          p.PrescriptionID, 
          p.PrescriptionDate, 
...
<head>
    ...
    <title>Dental Assistant - Patients</title>
    <!-- Google Fonts & Icons -->
        ...
        <div id="right_panel">
            ...
            <div id="header_with_selection">
                <div class="sub-navigation" style="margin: 20px">
                    <a href="Assistant-patients.php">Patient</a>
                    <?php if ($selectedPatient): ?>
                        <a href="Assistant-patients.php?view=<?= $selectedPatient['PatientID'] ?>">
            ...
            <!-- Main content area (Patient List) -->
            <div id="content" <?= isset($_GET['view']) ? 'style="display:none;"' : '' ?>>
                <h1>Patients</h1>
                            ...
                            <?php while ($prescription = mysqli_fetch_assoc($prescriptionResult)): ?>
                                <div class="medication_container">
                                    <div class="block_container">
                                        <div class="details_container">
                                            <div class="leftside">
                                                <img src="icons/dentalassistant/records_icon.png">
                                                <div class="filedeets">
                                                    <h2 class="big_file_name">
                                                        Prescription from Dr. <?= htmlspecialchars($prescription['DoctorFirst'] . ' ' . $prescription['DoctorLast']) ?>
                                                    </h2>
                                                    <div class="metadata">
                                                        <p class="file_date"><?= date("F j, Y", strtotime($prescription['PrescriptionDate'])) ?></p>
                                                        <p>•</p>
                                                        <p class="file_time"><?= date("h:i A", strtotime($prescription['created_at'])) ?></p>
                                                        <p>•</p>
                                            ...
                                            <div class="prescription_details">
                                                <p><strong>Medicine:</strong> <?= htmlspecialchars($prescription['Medicine']) ?></p>
                                                ...
                                                <p><strong>Refill Status:</strong> <?= htmlspecialchars($prescription['RefillStatus']) ?></p>
                                            </div>
                                            <a href="prescription_generate_pdf.php?prescription_id=<?= $prescription['PrescriptionID'] ?>" target="_blank">
                                                <button class="view_button">VIEW</button>
                                            </a>
                                        </div>
                                    </div>
